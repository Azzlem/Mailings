    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, max_length=150, null=True, verbose_name='старна')),
                ('token', models.CharField(blank=True, max_length=22, null=True, verbose_name='Token для верификации почты')),
